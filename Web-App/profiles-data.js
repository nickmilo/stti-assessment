...
window.STTI_PROFILES = {
  ...
  "IS-Architect": {
    ...
    "orientationDescription": {
      "content": "As an <strong>IS-Architect</strong>, you have a <strong>Western</strong> profile (notice how the image is predominantly focused on the western side). Your profile is also known as \"the philosopher.\" They often get stuck reflecting and ruminating, and have difficulty moving from thinking to doing."
    },
    "tendencyDescription": {
      "content": "The <strong>Architect</strong> is your dominant sensemaking tendency. This means you gravitate towards structuring and organizing the things around you. However, it doesn't mean the things around you are organized, only that you prefer clarity and understanding over uncertainty, but sometimes even…opportunities."
    },
